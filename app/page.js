    ...
    */
    ...
    return(
        ...
        <Section showUpTo="all" backgroundColor={theme["sectionTwo"][special].backgroundColor}>
          ...
          { backgroundColor:"rgb(156 156 156)",maxWidth:"500px", borderRadius:30}
          ||
          { backgroundColor:"rgb(156 156 156)",maxWidth:"500px",borderRadius:5}
          }>
        ...
        <Card css={{ backgroundColor:"rgb(156 156 156)", maxWidth:"500px", maxHeight:"450px", borderRadius:theme["sectionThree"][special].cardBorderRadius}}>
